...
public class Config_WorldView extends ConfigurationEntry_Base implements org.metatrans.apps.balloons.menu.IConfiguration_WorldView {
	...
	public Config_WorldView(int id, int name_Resource_ID, int bitmap_ResourceID, int bitmap_ResourceID_background, int bitmap_ResourceID_icon) {
